function plot_subjwise_beta_indicators(X_all, y_all, t, poststim, datatype, func)
...
for i = 1:length(X_all)
    ...
    [p1(i), p2(i)] = TS_signif(mu_low, mu_high, t, SIMlog_beta', PWlog_beta')
    title(['Subject ', num2str(i)])
    xlabel('Time (ms)')
    ylabel('Am/s')
    
end
%suptitle(['Beta power indicators ', num2str(BAND(1)), ' to ', num2str(BAND(2)), ' Hz'])
suptitle('Beta power indicators ')
