function plot_conditional_TS(X, y, t, poststim, datatype)
...
% split by hi/lo
[X_low, y_low] = beta_percentiles_subjectwise(X, y, [0,B], prestim, fs)
[X_high, y_high] = beta_percentiles_subjectwise(X,y, [1-B, 1], prestim, fs)
